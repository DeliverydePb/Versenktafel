async function misionSC7() {
	...
	let clima = await consultaClimaSC7(fecha, oceano);
	let conv = convSC7(clima);
	let sub = submarinosSC7();
	let textoMision = textoSC7(fecha, oceano, clima);
	let ordenesMision = ordenesSC7();
...
async function consultaClimaSC7(fecha, oceano) {
...
function textoSC7(fecha, oceano, clima) {
...
Confío en su experiencia y determinación, Kapitänleutnant. Que la fortuna lo acompañe. La Patria espera resultados.`;
	...
	texto.victoria = `El Convoy SC7 fue un convoy que partió desde Sydney, Canada, hacia Liverpool el 5 de Octubre de 1940.
Fué avistado el 17 de Octubre por el U-124, que ataco un barco rezagado. El BdU organizo un wolfpack para la noche siguiente.
En un ataque coordinado, los submarinos U-46, U-99, U-100, U-101 y U-123, lograron hundir 16 embarcaciones en 6 horas.
En total fueron hundidos 20 de los 37 mercantes, 6 resultaron dañados. Los aliados perdieron 79592 GRT.
Ningún submarino resultó dañado.
142 marineros no volvieron a casa.`;
